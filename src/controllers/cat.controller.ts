...
export const getCats = catchAsync(async (req: Request, res: Response) => {
...
export const createCat = catchAsync(async (req: Request, res: Response) => {
...
export const updateCat = catchAsync(async (req: Request, res: Response) => {
  const { name, price, breed, age, description, imageUrl } = req.body;
...
export const deleteCat = catchAsync(async (req: Request, res: Response) => {
  const cat = await Cat.findById(req.params.id);
